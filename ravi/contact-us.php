        ...
        <div class="container">
          <div class="logo">
            <div class="row">
              ...
              <div class="offset-lg-4 col-lg-2 col-md-6 col-sm-6 col-xs-6">
              ...
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-list">
                    <li><a class="nav-link" href="study-in-abroad.html">Study in Abroad</a></li>
      ...
      <main role="main" class="main">
        <div class="container">
			<div class="contact-us">
				...
				<form class="cf">
				  <div class="half left cf">
					...
					<input type="text" id="input-mobile" placeholder="Mobile" required>
				  </div>
			...
			<div class="map">
				<div class="row">
					<div class="col-lg-6">
						<address class="vcard text-center">
						   <div class="adr">
						      <div class="addr">Karlstraße 120</div>
						      <div class="addr">Düsseldorf</div > 
						      <div class="addr">D-40210</div >
						      <div class="addr">Germany</div >
						      <div class="addr">Tel: +49 1234 5678</div>
						      <div class="addr">Fax: <span class="fax">+49 1234 5679</span></div>
						   </div>						  
						</address>
					</div>
					<div class="col-lg-6">
...
http://pages.revox.io/frontend/1.1.0/html/05/ -->
